...
export default function ProductCard({ product, variant = 'default' }: ProductCardProps) {
  ...
  return (
    ...
    >
      {/* Image Container */}
      <div 
        className="relative aspect-[3/3.9] overflow-hidden"
          ...
          <>
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="w-1/2 bg-green-500 text-white text-sm font-bold py-2 px-2 rounded-lg hover:bg-green-600 transition-all duration-200 text-center shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center space-x-2"
              >
